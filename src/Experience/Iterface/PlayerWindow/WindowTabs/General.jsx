    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <Progress value={(financialStatement.cashFlow / 20000) * 100} className="h-2 bg-gray-700" indicatorClassName="bg-purple-600" />
            </div>
            <div>
                <div className="flex justify-between mb-2">
                ...
                <Progress value={(financialStatement.totalIncome / 10000) * 100} className="h-2 bg-gray-700" indicatorClassName="bg-orange-600" />
            </div>
            <div>
                <div className="flex justify-between mb-2">
                ...
                <Progress value={(financialStatement.totalExpenses / 10000) * 100} className="h-2 bg-gray-700" indicatorClassName="bg-red-600" />
            </div>
        </div>
    );
}